...
const EBOOK_LINKS = {
    ...
    PT: "https://go.hotmart.com/S104239705W"  // Portugués (Usando EN por ahora)
};

// --- DICCIONARIO DE TRADUCCIÓN (CEREBRO MULTILINGÜE) ---
const CONTENT = {
    ES: {
        subtitle: "The Harmony Station",
        placeholderName: "SU NOMBRE",
        placeholderAge: "EDAD",
        enterBtn: "ENTRAR AL ESTUDIO",
        step1: "Retrato Frontal", step2: "Perfil Derecho", step3: "Perfil Izquierdo",
        processing: "Procesando Belleza...",
        coverTitle: "The Aesthetic Dossier",
        coverCollection: "Collection",
        director: "Director Médico",
        edition: "Edition",
        // Pág 1
        ch1Title: "I. El Lienzo",
        ch1Sub: "Análisis de Calidad Dérmica",
        filterVasc: "Filtro Vascular",
        analysisTitle: "Análisis Espectral",
        analysisText: "Utilizamos Espectrometría de Contraste Vascular. Revela la inflamación crónica silente y el daño solar acumulado.",
        findingTitle: "Hallazgos",
        findingText: "Se detecta una barrera cutánea con signos de fatiga oxidativa y textura irregular, disminuyendo la luminosidad.",
        dxTitle: "Diagnóstico & Tratamiento",
        dxText: "Su piel requiere una restauración profunda de la matriz extracelular para recuperar el 'Glow'.",
        suggestion: "Sugerencia Experta",
        rx1: "Láser + Bio-Revitalización",
        // Pág 2
        ch2Title: "II. La Escultura",
        ch2Sub: "Dinámica de Paquetes Grasos",
        tagCheek: "▲ PÓMULO", tagJowl: "▼ JOWL",
        mapTitle: "Mapeo Volumétrico",
        mapText: "Visualizamos cómo los compartimentos de soporte se atrofian y los superficiales caen por gravedad.",
        cliTitle: "Hallazgos Clínicos",
        cliText: "Existe deflación en el tercio medio (pómulos), provocando que la piel pierda su anclaje y descienda.",
        quote: "No es exceso de piel, es falta de soporte.",
        txVol: "Tratamiento: Reposición Volumétrica",
        // Pág 3
        ch3Title: "III. Los Cimientos",
        ch3Sub: "Análisis del SMAS y Soporte Óseo",
        smasTitle: "SMAS (Tensión)",
        smasDx: "Dx: Laxitud ligamentaria y pérdida de tensión muscular.",
        boneTitle: "Soporte Óseo",
        boneDx: "Dx: Retracción en la apertura piriforme y mandíbula.",
        planTitle: "Su Plan de Transformación",
        optA: "Opción A: Médico",
        optADesc: "Intervención experta en consultorio.",
        btnBook: "Agendar Cita",
        optB: "Opción B: Casa",
        optBDesc: "Guía digital de cuidados.",
        btnBuy: "Comprar Ebook",
        approved: "Aprobado por",
        print: "Imprimir PDF",
        whatsapp: "Hola Dr. Maya, vi mi revista digital y quiero agendar."
    },
    EN: {
        subtitle: "The Harmony Station",
        ...
        step1: "Frontal Portrait", step2: "Right Profile", step3: "Left Profile",
        processing: "Processing Beauty...",
        coverTitle: "The Aesthetic Dossier",
        coverCollection: "Collection",
        director: "Medical Director",
        edition: "Edition",
        // Pág 1
        ch1Title: "I. The Canvas",
        ch1Sub: "Dermal Quality Analysis",
        filterVasc: "Vascular Filter",
        analysisTitle: "Spectral Analysis",
        analysisText: "We use Vascular Contrast Spectrometry. It reveals silent chronic inflammation and accumulated sun damage.",
        findingTitle: "Findings",
        findingText: "A skin barrier with signs of oxidative fatigue and irregular texture is detected, diminishing luminosity.",
        dxTitle: "Diagnosis & Treatment",
        dxText: "Your skin requires deep restoration of the extracellular matrix to recover its natural 'Glow'.",
        suggestion: "Expert Suggestion",
        rx1: "Laser + Bio-Revitalization",
        // Pág 2
        ch2Title: "II. The Sculpture",
        ch2Sub: "Fat Pad Dynamics",
        tagCheek: "▲ CHEEK", tagJowl: "▼ JOWL",
        mapTitle: "Volumetric Mapping",
        mapText: "We visualize how support compartments atrophy and superficial ones descend due to gravity.",
        cliTitle: "Clinical Findings",
        cliText: "There is deflation in the mid-face (cheeks), causing the skin to lose its anchor and descend.",
        quote: "It's not excess skin, it's lack of support.",
        txVol: "Treatment: Volumetric Repositioning",
        // Pág 3
        ch3Title: "III. The Foundation",
        ch3Sub: "SMAS & Bone Support Analysis",
        smasTitle: "SMAS (Tension)",
        smasDx: "Dx: Ligamentous laxity and loss of muscle tension.",
        boneTitle: "Bone Support",
        boneDx: "Dx: Retraction in the piriform aperture and mandible.",
        planTitle: "Your Transformation Plan",
        optA: "Option A: Medical",
        optADesc: "Expert office intervention.",
        btnBook: "Book Appointment",
        optB: "Option B: At Home",
        optBDesc: "Digital care guide.",
        btnBuy: "Buy Ebook",
        approved: "Approved by",
        print: "Print PDF",
        whatsapp: "Hello Dr. Maya, I saw my digital magazine and I want to book."
    },
    PT: {
        subtitle: "A Estação da Harmonia",
        placeholderName: "SEU NOME",
        placeholderAge: "IDADE",
        enterBtn: "ENTRAR NO ESTÚDIO",
        step1: "Retrato Frontal", step2: "Perfil Direito", step3: "Perfil Esquerdo",
        processing: "Processando Beleza...",
        coverTitle: "Dossiê Estético",
        coverCollection: "Coleção",
        director: "Diretor Médico",
        edition: "Edição",
        // Pág 1
        ch1Title: "I. A Tela",
        ch1Sub: "Análise de Qualidade Dérmica",
        filterVasc: "Filtro Vascular",
        analysisTitle: "Análise Espectral",
        analysisText: "Utilizamos Espectrometria de Contraste Vascular. Revela inflamação crônica silenciosa e dano solar acumulado.",
        findingTitle: "Achados",
        findingText: "Detecta-se uma barreira cutânea com sinais de fadiga oxidativa e textura irregular, diminuindo a luminosidade.",
        dxTitle: "Diagnóstico & Tratamento",
        dxText: "Sua pele requer uma restauração profunda da matriz extracelular para recuperar o 'Glow' natural.",
        suggestion: "Sugestão de Especialista",
        rx1: "Laser + Bio-Revitalização",
        // Pág 2
        ch2Title: "II. A Escultura",
        ch2Sub: "Dinâmica dos Compartimentos de Gordura",
        tagCheek: "▲ MALAR", tagJowl: "▼ JOWL",
        mapTitle: "Mapeamento Volumétrico",
        mapText: "Visualizamos como os compartimentos de suporte atrofiam e os superficiais descem pela gravidade.",
        cliTitle: "Achados Clínicos",
        cliText: "Existe deflação no terço médio (maçãs do rosto), fazendo com que a pele perca sua ancoragem e desça.",
        quote: "Não é excesso de pele, é falta de suporte.",
        txVol: "Tratamento: Reposição Volumétrica",
        // Pág 3
        ch3Title: "III. Os Fundamentos",
        ch3Sub: "Análise do SMAS e Suporte Ósseo",
        smasTitle: "SMAS (Tensão)",
        smasDx: "Dx: Laxidez ligamentar e perda de tensão muscular.",
        boneTitle: "Suporte Ósseo",
        boneDx: "Dx: Retração na abertura piriforme e mandíbula.",
        planTitle: "Seu Plano de Transformação",
        optA: "Opção A: Médico",
        optADesc: "Intervenção especializada.",
        btnBook: "Agendar Consulta",
        optB: "Opção B: Em Casa",
        optBDesc: "Guia digital de cuidados.",
        btnBuy: "Comprar Ebook",
        approved: "Aprovado por",
        print: "Imprimir PDF",
        whatsapp: "Olá Dr. Maya, vi minha revista digital e quero agendar."
    }
};

type LangType = 'ES' | 'EN' | 'PT';

export default function TipherethV900() {
  const webcamRef = useRef<Webcam>(null);
  const canvasRef = useRef<HTMLCanvasElement>(null);
  
  // --- ESTADOS ---
  const [lang, setLang] = useState<LangType>('ES'); // IDIOMA POR DEFECTO
