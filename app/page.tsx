...
export default function TipherethV750() {
  ...
  // --- GESTIÓN DE LEADS (ANTI-DUPLICADOS) ---
    ...
    <div className="min-h-screen bg-white text-black font-sans selection:bg-black selection:text-white overflow-x-hidden">
      ...
      {appMode === 'RESULT' && (
        <div className="bg-[#f0f0f0] min-h-screen md:py-10">
            ...
            {/* --- HOJA 2: VOLÚMENES (CORREGIDO POSICIÓN ANATÓMICA) --- */}
            <div className="max-w-[210mm] mx-auto bg-white shadow-2xl page-break">
                <MagazineHeader />
                ...
                <div className="relative mb-12 mx-8 shadow-2xl">
                     <div className="aspect-video w-full relative overflow-hidden bg-gray-100">
                         ...
                         {/* --- CORRECCIONES DE POSICIÓN ANATÓMICA (V750) --- */}
                         {/* MANCHA BEIGE (Pómulo): Centrada verticalmente (aprox 50%) */}
                         <div className="absolute top-[48%] left-[35%] w-16 h-12 bg-[#C4A484]/50 rounded-full blur-md border-2 border-[#C4A484]"></div>
                         
                         {/* MANCHA OSCURA (Jowl): En el tercio inferior (aprox 72%) */}
            ...
            <div className="max-w-[210mm] mx-auto bg-white shadow-2xl page-break flex flex-col">
                ...
                <div className="bg-black text-white p-8 mx-8 mb-8">
                    ...
                    <div className="mt-8 text-center"><p className="text-sm font-bold uppercase tracking-[0.3em] inline-block">Aprobado por: {DR_NAME}</p></div>
                </div>
            </div>
